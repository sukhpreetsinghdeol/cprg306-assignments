...
export default function ItemList({itemsProp, onItemSelect}){

    let itemArray = itemsProp.map( (obj) => ({...obj}) ); // creating new copy not a reference
    ...
    <div>
        ...
        <section className= "p-3">
            {itemArray.map( (itemObj) => ( 
                <Item item={itemObj} onSelect={ () => onItemSelect(itemObj.name)}
